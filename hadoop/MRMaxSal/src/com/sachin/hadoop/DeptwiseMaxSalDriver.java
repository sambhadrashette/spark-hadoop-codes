...
public class DeptwiseMaxSalDriver extends Configured implements Tool {
	public static void main(String[] args) {
		try {
			GenericOptionsParser parser = new GenericOptionsParser(args);
			Configuration conf = parser.getConfiguration();
			DeptwiseMaxSalDriver driver = new DeptwiseMaxSalDriver();
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "DeptwiseMaxSal");
		// set jar in which mapper & reducer class is present
		job.setJarByClass(DeptwiseMaxSalDriver.class);
